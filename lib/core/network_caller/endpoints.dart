class NetworkPath {
  ...
  static const String updateDriverOnboarding =
      '$_baseUrl/users/driver/onboarding';
  ...
  static const String myRidesHistory =
      "$_baseUrl/carTransports/my-rides-history";
  ...
  static const String onlineRidersList =
      "$_baseUrl/carTransports/my-rides-pending";
  static const String onboarding = "$_baseUrl/users/onboarding";
  static const String createReview = "$_baseUrl/reviews/create";
  static String carTransportsSingle(String id) =>
      "$_baseUrl/carTransports/single/$id";
  static String usersDeleteAccount(String id) =>
      "$_baseUrl/users/delete-account/$id";
}
